...
<body>
    ...
    <div class="relative overflow-x-auto bg-white h-auto px-5 py-4 border rounded-lg shadow-lg">
        <div class="flex justify-center items-center mb-5">
            <h1 class="text-xl font-bold italic">Tambah data guru</h1>
        </div>
        <div class="bg-gray-100 rounded-lg shadow-md px-5 py-5 w-auto">
            <form action="{{ route('teach.store') }}" method="POST">
                @csrf
                <div class="relative z-0 w-full mb-5 group" id="nama_group">
                    ...
                    <input type="text" name="nama" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                </div>
                ...
                <div class="relative z-0 w-full mb-5 group" id="nip_group">
                    ...
                    <input type="text" name="nip" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                </div>
